...
var httpHelper = {
    ...
    get: function (url, timeout, callback, encoding, header) {
        var options = require('url').parse(url);  //转换成对象
        options.method = 'GET';
        if (header) {
        ...
        switch (arguments.length){
            case 2:
                this.request(options, 60 * 1000, {}, callback, 'utf-8', '');
                break;
            case 3:
                this.request(options, 60 * 100, {}, callback, 'utf-8', header);
                break;
            case 4:
                this.request(options, timeout, {}, callback, 'utf-8', header);
                break;
            default:
